<template>
  <h-container id="teamLeaderOrder">
    ...
    <h-container>
      <h-header height="auto">
        ...
        >
          ...
          <!-- <h-form-item label="审批管教">
            <h-select v-model="formInline.region" placeholder="审批管教">
    ...
    >
      <wardApproval :typeapp="wardApprovalDialog.typeapp"></wardApproval>
    </h-dialog-block>
    <h-dialog-block
      ht="22%"
      wd="28%"
